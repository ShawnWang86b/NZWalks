...
public class NZWalksDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var difficulties = new List<Difficulty>()
        {
            new Difficulty()
            {
                Id = Guid.Parse("b36ded7e-e9a2-4941-bdec-ef70296f2ee6"),
                Name = "Easy"
            },
            new Difficulty()
            {
                Id = Guid.Parse("65529c40-e30b-4c85-93d3-902744067247"),
                Name = "Medium"
            },
            new Difficulty()
            {
                Id = Guid.Parse("c1d22716-4bef-46ad-81a9-344fb0783c19"),
                Name = "Hard"
            }
        };
